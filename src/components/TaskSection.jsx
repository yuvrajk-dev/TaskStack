...
const TaskSection = ({ taskObject = [], getTasks, getTaskLoading }) => {
  ...
  return (
    <section className="w-[96%]  min-h-0   mx-auto flex-1 p-5 mb-2 pb-40 border-(--border) border rounded-xl  bg-(--surface)  md:flex-row flex flex-col gap-5 overflow-y-auto justify-start items-center md:justify-center md:items-start scrollbar-hide  ">
